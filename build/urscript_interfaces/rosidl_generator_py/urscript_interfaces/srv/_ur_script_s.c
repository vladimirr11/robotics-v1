...
bool urscript_interfaces__srv__ur_script__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("urscript_interfaces.srv._ur_script.UrScript_Request", full_classname_dest, 51) == 0);
  }
  urscript_interfaces__srv__UrScript_Request * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of UrScript_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("urscript_interfaces.srv._ur_script");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UrScript_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool urscript_interfaces__srv__ur_script__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("urscript_interfaces.srv._ur_script.UrScript_Response", full_classname_dest, 52) == 0);
  }
  urscript_interfaces__srv__UrScript_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of UrScript_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("urscript_interfaces.srv._ur_script");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UrScript_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
