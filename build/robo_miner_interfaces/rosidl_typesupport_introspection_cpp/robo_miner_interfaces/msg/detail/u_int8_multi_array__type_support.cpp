...
{
  new (message_memory) robo_miner_interfaces::msg::UInt8MultiArray(_init);
}

void UInt8MultiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_miner_interfaces::msg::UInt8MultiArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UInt8MultiArray_message_member_array[3] = {
  {
    "rows",  // name
    ...
    offsetof(robo_miner_interfaces::msg::UInt8MultiArray, rows),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_miner_interfaces::msg::UInt8MultiArray, cols),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_miner_interfaces::msg::UInt8MultiArray, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UInt8MultiArray_message_members = {
  ...
  3,  // number of fields
  sizeof(robo_miner_interfaces::msg::UInt8MultiArray),
...
{
  return &::robo_miner_interfaces::msg::rosidl_typesupport_introspection_cpp::UInt8MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_miner_interfaces, msg, UInt8MultiArray)() {
  return &::robo_miner_interfaces::msg::rosidl_typesupport_introspection_cpp::UInt8MultiArray_message_type_support_handle;
}
