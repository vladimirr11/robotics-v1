...
#include "robo_miner_interfaces/msg/detail/u_int8_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _UInt8MultiArray__ros_msg_type = robo_miner_interfaces__msg__UInt8MultiArray;
...
static uint32_t _UInt8MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_miner_interfaces__msg__UInt8MultiArray(
...
{
  return max_serialized_size_robo_miner_interfaces__msg__UInt8MultiArray(
    full_bounded, 0);
}
