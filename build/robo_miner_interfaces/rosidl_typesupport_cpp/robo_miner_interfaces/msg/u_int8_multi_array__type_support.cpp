...
static const _UInt8MultiArray_type_support_symbol_names_t _UInt8MultiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_miner_interfaces, msg, UInt8MultiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_miner_interfaces, msg, UInt8MultiArray)),
  }
};
...
{
  return &::robo_miner_interfaces::msg::rosidl_typesupport_cpp::UInt8MultiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_miner_interfaces, msg, UInt8MultiArray)() {
  return get_message_type_support_handle<robo_miner_interfaces::msg::UInt8MultiArray>();
}
