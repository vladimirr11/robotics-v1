...
static const _FieldPoint_type_support_symbol_names_t _FieldPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_miner_interfaces, msg, FieldPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_miner_interfaces, msg, FieldPoint)),
  }
};
...
{
  return &::robo_miner_interfaces::msg::rosidl_typesupport_cpp::FieldPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_miner_interfaces, msg, FieldPoint)() {
  return get_message_type_support_handle<robo_miner_interfaces::msg::FieldPoint>();
}
