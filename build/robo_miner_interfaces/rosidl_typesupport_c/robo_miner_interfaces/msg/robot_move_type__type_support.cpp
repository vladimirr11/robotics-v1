...
static const _RobotMoveType_type_support_symbol_names_t _RobotMoveType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_miner_interfaces, msg, RobotMoveType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_miner_interfaces, msg, RobotMoveType)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_miner_interfaces, msg, RobotMoveType)() {
  return &::robo_miner_interfaces::msg::rosidl_typesupport_c::RobotMoveType_message_type_support_handle;
}
