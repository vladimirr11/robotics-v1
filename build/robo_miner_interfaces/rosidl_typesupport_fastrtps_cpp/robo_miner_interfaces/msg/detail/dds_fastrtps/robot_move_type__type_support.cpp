...
#include "robo_miner_interfaces/msg/detail/robot_move_type__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const robo_miner_interfaces::msg::RobotMoveType *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_miner_interfaces::msg::RobotMoveType *>(
    untyped_ros_message);
...
{
  return &robo_miner_interfaces::msg::typesupport_fastrtps_cpp::_RobotMoveType__handle;
}
