...
#include "robo_miner_interfaces/msg/detail/field_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robo_miner_interfaces::msg::FieldPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robo_miner_interfaces::msg::FieldPoint & ros_message)
{
  // Member: row
  cdr >> ros_message.row;
...
{
  auto typed_message =
    static_cast<const robo_miner_interfaces::msg::FieldPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_miner_interfaces::msg::FieldPoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FieldPoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robo_miner_interfaces::msg::FieldPoint *>(
...
{
  return max_serialized_size_FieldPoint(full_bounded, 0);
}

static message_type_support_callbacks_t _FieldPoint__callbacks = {
...
static rosidl_message_type_support_t _FieldPoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FieldPoint__callbacks,
...
{
  return &robo_miner_interfaces::msg::typesupport_fastrtps_cpp::_FieldPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_miner_interfaces, msg, FieldPoint)() {
  return &robo_miner_interfaces::msg::typesupport_fastrtps_cpp::_FieldPoint__handle;
}
