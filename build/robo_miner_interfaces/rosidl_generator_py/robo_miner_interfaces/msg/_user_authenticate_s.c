...
bool robo_miner_interfaces__msg__user_authenticate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robo_miner_interfaces.msg._user_authenticate.UserAuthenticate", full_classname_dest, 61) == 0);
  }
  robo_miner_interfaces__msg__UserAuthenticate * ros_message = _ros_message;
  {  // user
...
PyObject * robo_miner_interfaces__msg__user_authenticate__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robo_miner_interfaces.msg._user_authenticate");
