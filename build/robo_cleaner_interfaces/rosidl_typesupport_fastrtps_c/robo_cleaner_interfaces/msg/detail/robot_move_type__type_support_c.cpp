...
#include "robo_cleaner_interfaces/msg/detail/robot_move_type__rosidl_typesupport_fastrtps_c.h"
...
using _RobotMoveType__ros_msg_type = robo_cleaner_interfaces__msg__RobotMoveType;
...
static uint32_t _RobotMoveType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_cleaner_interfaces__msg__RobotMoveType(
...
{
  return max_serialized_size_robo_cleaner_interfaces__msg__RobotMoveType(
    full_bounded, 0);
}
