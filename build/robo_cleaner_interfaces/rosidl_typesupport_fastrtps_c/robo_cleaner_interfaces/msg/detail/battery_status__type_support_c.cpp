...
#include "robo_cleaner_interfaces/msg/detail/battery_status__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryStatus__ros_msg_type = robo_cleaner_interfaces__msg__BatteryStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: max_moves_on_full_energy
  {
    cdr << ros_message->max_moves_on_full_energy;
  }

  // Field name: moves_left
  {
...
static uint32_t _BatteryStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_cleaner_interfaces__msg__BatteryStatus(
...
{
  return max_serialized_size_robo_cleaner_interfaces__msg__BatteryStatus(
    full_bounded, 0);
}
