...
#include "robo_cleaner_interfaces/msg/detail/robot_move_type__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robo_cleaner_interfaces::msg::RobotMoveType & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robo_cleaner_interfaces::msg::RobotMoveType & ros_message)
{
  // Member: move_type
  cdr >> ros_message.move_type;
...
{
  auto typed_message =
    static_cast<const robo_cleaner_interfaces::msg::RobotMoveType *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_cleaner_interfaces::msg::RobotMoveType *>(
    untyped_ros_message);
...
{
  return &robo_cleaner_interfaces::msg::typesupport_fastrtps_cpp::_RobotMoveType__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_cleaner_interfaces, msg, RobotMoveType)() {
  return &robo_cleaner_interfaces::msg::typesupport_fastrtps_cpp::_RobotMoveType__handle;
}
