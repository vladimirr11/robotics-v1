...
#include <stddef.h>
#include "robo_cleaner_interfaces/msg/detail/user_authenticate__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  robo_cleaner_interfaces__msg__UserAuthenticate__init(message_memory);
}

void UserAuthenticate__rosidl_typesupport_introspection_c__UserAuthenticate_fini_function(void * message_memory)
{
  robo_cleaner_interfaces__msg__UserAuthenticate__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember UserAuthenticate__rosidl_typesupport_introspection_c__UserAuthenticate_message_member_array[3] = {
  {
    ...
    offsetof(robo_cleaner_interfaces__msg__UserAuthenticate, user),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_cleaner_interfaces__msg__UserAuthenticate, repository),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_cleaner_interfaces__msg__UserAuthenticate, commit_sha),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers UserAuthenticate__rosidl_typesupport_introspection_c__UserAuthenticate_message_members = {
  ...
  3,  // number of fields
  sizeof(robo_cleaner_interfaces__msg__UserAuthenticate),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_cleaner_interfaces, msg, UserAuthenticate)() {
