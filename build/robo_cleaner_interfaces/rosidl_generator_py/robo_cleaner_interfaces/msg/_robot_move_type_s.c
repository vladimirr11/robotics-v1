...
bool robo_cleaner_interfaces__msg__robot_move_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robo_cleaner_interfaces.msg._robot_move_type.RobotMoveType", full_classname_dest, 58) == 0);
  }
  robo_cleaner_interfaces__msg__RobotMoveType * ros_message = _ros_message;
  {  // move_type
...
PyObject * robo_cleaner_interfaces__msg__robot_move_type__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robo_cleaner_interfaces.msg._robot_move_type");
