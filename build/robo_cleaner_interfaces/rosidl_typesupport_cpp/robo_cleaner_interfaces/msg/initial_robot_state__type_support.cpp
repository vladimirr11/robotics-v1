...
static const _InitialRobotState_type_support_symbol_names_t _InitialRobotState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_cleaner_interfaces, msg, InitialRobotState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_cleaner_interfaces, msg, InitialRobotState)),
  }
};
...
{
  return &::robo_cleaner_interfaces::msg::rosidl_typesupport_cpp::InitialRobotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_cleaner_interfaces, msg, InitialRobotState)() {
  return get_message_type_support_handle<robo_cleaner_interfaces::msg::InitialRobotState>();
}
