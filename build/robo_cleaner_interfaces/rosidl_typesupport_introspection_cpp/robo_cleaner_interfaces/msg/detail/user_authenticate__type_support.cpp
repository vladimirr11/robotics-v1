...
{
  new (message_memory) robo_cleaner_interfaces::msg::UserAuthenticate(_init);
}

void UserAuthenticate_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_cleaner_interfaces::msg::UserAuthenticate *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UserAuthenticate_message_member_array[3] = {
  {
    ...
    offsetof(robo_cleaner_interfaces::msg::UserAuthenticate, user),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_cleaner_interfaces::msg::UserAuthenticate, repository),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robo_cleaner_interfaces::msg::UserAuthenticate, commit_sha),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UserAuthenticate_message_members = {
  ...
  3,  // number of fields
  sizeof(robo_cleaner_interfaces::msg::UserAuthenticate),
...
{
  return &::robo_cleaner_interfaces::msg::rosidl_typesupport_introspection_cpp::UserAuthenticate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_cleaner_interfaces, msg, UserAuthenticate)() {
  return &::robo_cleaner_interfaces::msg::rosidl_typesupport_introspection_cpp::UserAuthenticate_message_type_support_handle;
}
