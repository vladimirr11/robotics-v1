...
{
  new (message_memory) robo_cleaner_interfaces::msg::RobotMoveType(_init);
}

void RobotMoveType_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robo_cleaner_interfaces::msg::RobotMoveType *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotMoveType_message_member_array[1] = {
  {
    ...
    offsetof(robo_cleaner_interfaces::msg::RobotMoveType, move_type),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotMoveType_message_members = {
  ...
  1,  // number of fields
  sizeof(robo_cleaner_interfaces::msg::RobotMoveType),
...
{
  return &::robo_cleaner_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotMoveType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_cleaner_interfaces, msg, RobotMoveType)() {
  return &::robo_cleaner_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotMoveType_message_type_support_handle;
}
