...
#include "robo_collector_interfaces/msg/detail/user_authenticate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robo_collector_interfaces::msg::UserAuthenticate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robo_collector_interfaces::msg::UserAuthenticate & ros_message)
{
  // Member: user
  cdr >> ros_message.user;
...
{
  auto typed_message =
    static_cast<const robo_collector_interfaces::msg::UserAuthenticate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robo_collector_interfaces::msg::UserAuthenticate *>(
    untyped_ros_message);
...
{
  return &robo_collector_interfaces::msg::typesupport_fastrtps_cpp::_UserAuthenticate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_collector_interfaces, msg, UserAuthenticate)() {
  return &robo_collector_interfaces::msg::typesupport_fastrtps_cpp::_UserAuthenticate__handle;
}
