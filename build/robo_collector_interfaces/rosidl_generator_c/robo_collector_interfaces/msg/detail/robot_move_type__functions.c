...
bool
robo_collector_interfaces__msg__RobotMoveType__are_equal(const robo_collector_interfaces__msg__RobotMoveType * lhs, const robo_collector_interfaces__msg__RobotMoveType * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
robo_collector_interfaces__msg__RobotMoveType__copy(
  const robo_collector_interfaces__msg__RobotMoveType * input,
  robo_collector_interfaces__msg__RobotMoveType * output)
{
  if (!input || !output) {
    return false;
  }
...
robo_collector_interfaces__msg__RobotMoveType__create()
{
  ...
  robo_collector_interfaces__msg__RobotMoveType * msg = (robo_collector_interfaces__msg__RobotMoveType *)allocator.allocate(sizeof(robo_collector_interfaces__msg__RobotMoveType), allocator.state);
  if (!msg) {
    return NULL;
  }
...
robo_collector_interfaces__msg__RobotMoveType__Sequence__init(robo_collector_interfaces__msg__RobotMoveType__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (robo_collector_interfaces__msg__RobotMoveType *)allocator.zero_allocate(size, sizeof(robo_collector_interfaces__msg__RobotMoveType), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robo_collector_interfaces__msg__RobotMoveType__Sequence * array = (robo_collector_interfaces__msg__RobotMoveType__Sequence *)allocator.allocate(sizeof(robo_collector_interfaces__msg__RobotMoveType__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
robo_collector_interfaces__msg__RobotMoveType__Sequence__are_equal(const robo_collector_interfaces__msg__RobotMoveType__Sequence * lhs, const robo_collector_interfaces__msg__RobotMoveType__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robo_collector_interfaces__msg__RobotMoveType__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
robo_collector_interfaces__msg__RobotMoveType__Sequence__copy(
  const robo_collector_interfaces__msg__RobotMoveType__Sequence * input,
  robo_collector_interfaces__msg__RobotMoveType__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robo_collector_interfaces__msg__RobotMoveType);
    robo_collector_interfaces__msg__RobotMoveType * data =
      (robo_collector_interfaces__msg__RobotMoveType *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robo_collector_interfaces__msg__RobotMoveType__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          robo_collector_interfaces__msg__RobotMoveType__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robo_collector_interfaces__msg__RobotMoveType__copy(
