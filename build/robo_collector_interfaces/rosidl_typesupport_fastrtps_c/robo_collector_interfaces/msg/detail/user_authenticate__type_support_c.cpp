...
#include "robo_collector_interfaces/msg/detail/user_authenticate__rosidl_typesupport_fastrtps_c.h"
...
#include "robo_collector_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _UserAuthenticate__ros_msg_type = robo_collector_interfaces__msg__UserAuthenticate;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_collector_interfaces
size_t get_serialized_size_robo_collector_interfaces__msg__UserAuthenticate(
  const void * untyped_ros_message,
...
static uint32_t _UserAuthenticate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_collector_interfaces__msg__UserAuthenticate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_collector_interfaces
size_t max_serialized_size_robo_collector_interfaces__msg__UserAuthenticate(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_robo_collector_interfaces__msg__UserAuthenticate(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_collector_interfaces, msg, UserAuthenticate)() {
